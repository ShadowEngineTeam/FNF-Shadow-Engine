...
private abstract NodeAccess(Xml) from Xml to Xml
{
	...
	{
		return getHelper(name, (msg:String) -> FlxG.log.warn(msg));
	}
	
	public function getError(name:String)
	{
		return getHelper(name, (msg:String) -> FlxG.log.error(msg));	
	}
}
...
private abstract AttribAccess(Xml) from Xml to Xml
{
	...
	{
		return stringHelper(name, (msg:String) -> FlxG.log.warn(msg), backup);
	}
	
	public function stringError(name:String, ?backup:String)
	{
		return stringHelper(name, (msg:String) -> FlxG.log.error(msg), backup);
	}
	...
	{
		return intHelper(name, (msg:String) -> FlxG.log.warn(msg), backup);
	}
	
	public function intError(name:String, backup:Int)
	{
		return intHelper(name, (msg:String) -> FlxG.log.error(msg), backup);
	}
	...
	{
		return boolHelper(name, (msg:String) -> FlxG.log.warn(msg), backup);
	}
	
	public function boolError(name:String, backup:Bool)
	{
		return boolHelper(name, (msg:String) -> FlxG.log.error(msg), backup);
	}
}