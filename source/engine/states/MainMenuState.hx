...
{
	public static var shadowEngineVersion:String = '0.10.0'; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		shadowVer.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(shadowVer);
